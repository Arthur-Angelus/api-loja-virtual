let produtos = [
    {
        id: 1,
        nome: "Camiseta",
        descricao: "Camiseta de algodão unissex, tamanho M, cor preta, tematica de starwars",
        preco: 39.90,
        categoria: "Roupas",
        estoque: 50,
        ativo: true
    },
    {
        id: 2,
        nome: "Fone",
        descricao: "Fone sem fio com cancelamento de ruído, 15 horas de bateria, tematica de starwars",
        preco: 159.90,
    ...
    },
    {
        id: 3,
        nome: "Caneca",
        descricao: "Caneca personalizada de 400ml, tema de starwars",
        preco: 29.90,
